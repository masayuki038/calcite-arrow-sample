...
libraryDependencies += "org.apache.calcite" % "calcite-core" % "1.14.0"
libraryDependencies += "org.apache.calcite" % "calcite-linq4j" % "1.14.0"
...
libraryDependencies += "org.apache.arrow" % "arrow-vector" % "0.7.1"
